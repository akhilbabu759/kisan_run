...
insert  into `delvery`(`#`,`user_name`,`user_id`,`locality`,`product_id`,`product_name`,`payment`,`quntity`,`statuse`,`date`,`ph_no`,`time`) values (1,'akhil',1,'payam','1','thy','cod-100',7,'pending','4/9/2002',2147483647,'10:20'),(2,'arun',2,'payam','1','thy','cod-300',17,'deleverd','4/9/2002',789978766,'10:08'),(3,'manu',3,'kunnoth','1','thy','cod-20',1,'pending','8/7/2004',2147483647,'10:30');
...
insert  into `feedback`(`feedback_id`,`feedback`,`date`,`user_name`) values (1,'blknjghlkm','11/12/2001','ahil'),(2,NULL,NULL,NULL);
...
insert  into `product`(`product_id`,`product_name`,`details`,`stock`,`price`,`user_id`) values (1,'thy','atryuh',6,180,1),(2,'uio','hggvg',109,56,2);
...
insert  into `soil_report`(`soilreport_id`,`user_id`,`amount`,`date`,`report`) values (1,2,400,'2000-12-06','/static/kisan/20220107102511.pdf'),(2,3,500,'2020-01-06','pending');
